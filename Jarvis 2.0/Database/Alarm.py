...
extracted_time = open('C:\\Jarvis 2.0\\Data\\Data.txt','rt')
time = extracted_time.read()
Time = str(time)

delete_time = open('C:\\Jarvis 2.0\\Data\\Data.txt','r+')
...
def RingerNow(time):
    ...
    while True:
        ...
        if current_time == Alarm_Time:
            print("Wake Up Sir!")
            playsound("C:\\Users\\91831\\Downloads\\emergency-alarm-with-reverb-29431.mp3")
